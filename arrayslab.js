...
////////////////////
//Would this have worked as a cleaner or good code if the requirements did not include using for, for of, or forEach:

//        const nums2 = [100, 5, 23, 15, 21, 72, 9, 45, 66, 7, 81, 90].filter((number) => number%2!==0)
 //         const odds =[]
 //           odds.push(nums2)
...
//create new array named odds
const odds =[]
//create loop to iterate through nums
...
const numList = []
    ...
    numList.push(...numArrays.slice(-1))
